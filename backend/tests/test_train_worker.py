...
class TrainWorkerTest(unittest.TestCase):
    ...
    def test_actual_train_rejects_non_detection_checkpoint_before_training(self):
        emitted = []
        train_called = []
        ...
        self.assertTrue(any("detection checkpoint" in item.get("error", "") for item in emitted))
