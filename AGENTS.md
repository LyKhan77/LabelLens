...
- **Dataset Manager** — Standalone `/datasets` page for multi-project dataset management. Roboflow-style thumbnail gallery, modal review with granular overlay controls, batch auto-label jobs with configurable frame sampling, and zip export.
