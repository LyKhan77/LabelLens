...
- Overall: Awaiting `models/yoloe-26l-seg.pt` and `models/yoloe-26l-seg-pf.pt` placement plus real YOLO detection/segmentation training checkpoints / hardware validation on RTX 5080 devices with `CUDA_DEVICE_ORDER=PCI_BUS_ID`
